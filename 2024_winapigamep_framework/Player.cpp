	...
	: m_pTex(nullptr)
{
	...
	m_pDeadTex = GET_SINGLE(ResourceManager)->TextureLoad(L"PlayerDead", L"Texture\\Player\\Player_Die.bmp");
	...
	stateMachine->AddState(PLAYER_STATE::JUMP, new PlayerJumpState(this, stateMachine, L"PlayerMove"));
